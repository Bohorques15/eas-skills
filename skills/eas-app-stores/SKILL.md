...
Derived from the MIT-licensed Expo [`eas-app-stores`](https://github.com/expo/skills/blob/main/plugins/expo/skills/eas-app-stores/SKILL.md) skill. This pack is not the official Expo plugin (`expo@claude-plugins-official`). Store emails, passwords, and service-account paths in examples are placeholders.
